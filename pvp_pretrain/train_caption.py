...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Caption.CSC = True  # class-specific context
    ...
    cfg.TRAIN.global_size = 224
    cfg.TRAIN.local_size = 96
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-data", type=str, default="../data/pretrain_200w.txt", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
